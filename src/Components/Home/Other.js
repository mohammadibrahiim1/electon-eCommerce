  ...
  return (
    <div>
      <section className="other-section container">
        {/* <a href="https://imgbb.com/"><img src="https://i.ibb.co/Jq0bX8y/11-1-1.png" alt="11-1-1" border="0"></a> */}
      ...
      <section className="container">
        <div>
          <h3 className="review-title mb-4">Reviews</h3>
        </div>
        ...
        <div className="review-container">
          <div class="card shadow mb-3" style={{ "max-width": "400px" }}>
            <div class="row g-0">
              ...
              <p class="card-text review ms-5 p-3 mt-2 mb-3">
