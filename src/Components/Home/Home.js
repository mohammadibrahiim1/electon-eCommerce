...
const Home = () => {
    ...
    return (
        ...
        <div id="carouselExampleControls" class="carousel slide " data-bs-ride="carousel">
          <div class="carousel-inner container m-auto">
            <div class="carousel-item active bg-white ps-5 pe-5 pt-3 pb-3  mt-5">
              <div class="row">
                <div class="col-lg-7 d-flex align-items-center">
                 <div>
                  ...
                  <h1>$400</h1>
                  <div class="btn panda-button-bg" id="buynow">
                    Buy Now
                  </div>
                 </div>
            ...
            <div class="carousel-item active bg-white  p-5 pe-5 pt-3 pb-3  border-0 mt-5">
              <div class="row">
                <div class="col-lg-7 d-flex align-items-center ">
                 <div>
                  <h1>Canon Camera</h1>
                  ...
                  <h1>$400</h1>
                  <div class="btn btn panda-button-bg">
                    Buy Now
                  </div>
                 </div>
                ...
                <div class="col-lg-5 carousel-img">
                  <img src="https://i.ibb.co/xMFvbvb/Frame-29.png"  alt="..."/>
                 </div>
              </div>
            
            </div>
            <div class="carousel-item active bg-white p-5 pe-5 pt-3 pb-3  mt-5">
              <div class="row">
                <div class="col-lg-7 d-flex align-items-center ">
                 <div>
                ...
                <div class="col-lg-5 carousel-img">
                  <img src="https://i.ibb.co/LQ7TPqC/Frame-29-3.png" alt="..."/>
                 </div>
              </div>
